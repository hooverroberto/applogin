    ...
    <div class="container">
        <div class="row vh-100 justify-content-around align-items-center">
            <div class="card p-5" style="width: 28rem;">
                <img class="mb-2" src="images/devchallenges.svg" alt="" style="width: 10rem;">
                ...
                <input type="submit" class="form-control btn btn-primary mt-2" value="Enviar" />
                ...
                <p class="mt-3 text-center">Adready a member? <span class="text-primary"> <a class="text-decoration-none" href="#">Login</a>  </span></p>
            </div>
        </div>
    </div>
</body>
